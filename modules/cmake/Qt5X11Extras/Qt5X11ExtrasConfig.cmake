...
set(Qt5X11Extras_VERSION_STRING 5.12.3)
...
if (NOT TARGET Qt5::X11Extras)
    ...
    foreach(_module_dep ${_Qt5X11Extras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.3 ${_Qt5X11Extras_FIND_VERSION_EXACT}
    ...
    _populate_X11Extras_target_properties(RELEASE "libQt5X11Extras.so.5.12.3" "" )
    ...
    macro(_populate_X11Extras_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5X11Extras_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_X11Extras_check_file_exists(${imported_location})
