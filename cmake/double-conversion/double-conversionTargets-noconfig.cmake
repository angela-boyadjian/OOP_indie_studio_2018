...
set_target_properties(double-conversion::double-conversion PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libdouble-conversion.so.3.1.5"
  IMPORTED_SONAME_NOCONFIG "libdouble-conversion.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS double-conversion::double-conversion )
list(APPEND _IMPORT_CHECK_FILES_FOR_double-conversion::double-conversion "${_IMPORT_PREFIX}/lib/libdouble-conversion.so.3.1.5" )
